...
_Every claim above is cross-referenced against the actual community configs fetched on 2026-07-06 from their original GitHub sources. Config line references in this document refer to our files at `~/.config/opencode/opencode.jsonc` and `~/.config/opencode/oh-my-openagent.jsonc`._
