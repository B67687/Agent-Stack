> **SUPERSEDED (2026-08-02)** — this 07-18 audit predates the routing consolidation. The live routing policy is `.opencode/rules/model-routing.mdc` (whole paid stack on deepseek-v4-flash 0731, qwen3.7-plus fallback reserve, minimax-m3 visual-only; see docs/CHANGELOG.md v1.5–v1.6). Retained for historical record only — do not treat its model/routing claims as current.
