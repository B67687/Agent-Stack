...
| Model concurrency    | hy3:10, deepseek-v4-flash:2, gpt-5.6-luna:2, minimax-m3:2, glm-5.2:2, mimo-v2.5-free:10, qwen3.7-max:0 (budget-blocked) | —       | Per-model caps (updated 2026-08-25: hy3 primary=10, deepseek-v4-flash dropped to 2, glm-5.2=2 added, deepseek-v4-flash-free removed — does not exist on platform) |
