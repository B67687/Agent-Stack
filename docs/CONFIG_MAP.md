...
| Model concurrency    | mimo-v2.5:10, muse-spark-1.2-contributor:15, mimo-v2.5-free:10, gpt-5.6-luna:2, minimax-m3:2, glm-5.2:2, deepseek-v4-flash:2, qwen3.7-max:0 (budget-blocked) | —       | Per-model caps (updated 2026-08-26: hybrid privacy routing — mimo-v2.5=10 for sensitive, muse-spark=15 for low-sensitivity) |
...
|                                       | `fallback_models` (per agent/category)                      | 6-entry allowlist: opencode-go/mimo-v2.5, opencode-go/gpt-5.6-luna, opencode-go/minimax-m3, opencode-go/deepseek-v4-flash, opencode-go/glm-5.2, opencode/mimo-v2.5-free | Added 2026-08-03; updated 2026-08-26 — suppresses OMO hardcoded AGENT_MODEL_REQUIREMENTS fallback chain (was claude-opus-5/anthropic on transient errors, 'insufficient balance' mystery; Test 5 enforces) |
...
Summary (updated 2026-08-26): Go workhorse `opencode-go/mimo-v2.5` is now PRIMARY, covering the whole paid stack (21 agents/categories); `opencode-go/gpt-5.6-luna` (budget-frontier) on Test-Writer/Review; `opencode-go/minimax-m3` (visual) on visual-engineering; Zen free tier on explore/scout/quick/unspecified-low/sisyphus-junior/librarian/multimodal-looker/writing/git (mimo-v2.5-free — deepseek-v4-flash-free does not exist on platform).
